module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      dist: {
        ...
        files: {
          "dist/css/bootstrap-select.css": "sass/bootstrap-select.scss",
        },
      },
    },
    ...
    version: {
      ...
      default: {
        ...
        src: ["docs/mkdocs.yml", "package.json"],
      },
    },
  ...
  grunt.registerTask('build-css', ['clean:css', 'sass', 'postcss', 'usebanner:css', 'cssmin']);
